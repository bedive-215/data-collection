...
-- ============================================================
-- 2. SURVEYS
-- Thêm: access_type, access_token (bỏ is_published không có trong bảng)
-- ============================================================

INSERT IGNORE INTO `surveys`
  (`id`, `title`, `description`, `created_by`, `start_at`, `end_at`, `settings`, `access_type`, `access_token`, `created_at`, `updated_at`, `deleted_at`)
VALUES
(
...
(
  ...
  'LINK', 'token-survey-3-secret',
  NOW(), NOW(), NULL
);

-- ============================================================
-- 3. QUESTIONS
-- (Không thay đổi — cấu trúc khớp)
-- ============================================================
...
-- ============================================================
-- 5. RESPONSES
-- Thêm: submitted_at (có trong bảng thực tế)
-- ============================================================

INSERT IGNORE INTO `responses`
  (`id`, `survey_id`, `user_id`, `submitted_at`, `created_at`, `updated_at`)
VALUES
('e1000001-0001-4000-8000-000000000001', 'b1b2c3d4-0001-4000-8000-000000000001', 'a1b2c3d4-0002-4000-8000-000000000002', NOW(), NOW(), NOW()),
('e1000001-0002-4000-8000-000000000002', 'b1b2c3d4-0001-4000-8000-000000000001', 'a1b2c3d4-0003-4000-8000-000000000003', NOW(), NOW(), NOW()),
('e2000001-0001-4000-8000-000000000003', 'b1b2c3d4-0002-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', NOW(), NOW(), NOW()),
('e3000001-0001-4000-8000-000000000004', 'b1b2c3d4-0003-4000-8000-000000000003', 'a1b2c3d4-0005-4000-8000-000000000005', NOW(), NOW(), NOW()),
('e1000001-0003-4000-8000-000000000005', 'b1b2c3d4-0001-4000-8000-000000000001', NULL,                                    NOW(), NOW(), NOW());

-- ============================================================
-- 6. ANSWERS
-- Thêm: selected_options (JSON cho MULTIPLE_CHOICE), answer_number, answer_date
-- - SINGLE_CHOICE  → option_id
-- - MULTIPLE_CHOICE → selected_options (JSON array of option_ids) + option_id cho từng dòng
-- - TEXT/PARAGRAPH → answer_text
-- ============================================================

INSERT IGNORE INTO `answers`
  (`id`, `response_id`, `question_id`, `option_id`, `selected_options`, `answer_text`, `answer_number`, `answer_date`)
VALUES
-- Response 1 (User 2, Survey 1)
-- Q1: SINGLE_CHOICE → "Hài lòng"
('f0000001-0001-4000-8000-000000000001', 'e1000001-0001-4000-8000-000000000001', 'c1000001-0001-4000-8000-000000000001', 'd1010001-0002-4000-8000-000000000002', NULL, NULL, NULL, NULL),
-- Q2: MULTIPLE_CHOICE → "Thái độ nhân viên" + "Giá cả hợp lý"
('f0000001-0002-4000-8000-000000000002', 'e1000001-0001-4000-8000-000000000001', 'c1000001-0002-4000-8000-000000000002', NULL, '["d1020001-0001-4000-8000-000000000001","d1020001-0003-4000-8000-000000000003"]', NULL, NULL, NULL),
-- Q3: TEXT
('f0000001-0003-4000-8000-000000000003', 'e1000001-0001-4000-8000-000000000001', 'c1000001-0003-4000-8000-000000000003', NULL, NULL, 'Mong nhân viên hỗ trợ nhanh hơn', NULL, NULL),

-- Response 2 (User 3, Survey 1)
-- Q1: SINGLE_CHOICE → "Rất hài lòng"
('f0000002-0001-4000-8000-000000000004', 'e1000001-0002-4000-8000-000000000002', 'c1000001-0001-4000-8000-000000000001', 'd1010001-0001-4000-8000-000000000001', NULL, NULL, NULL, NULL),
-- Q2: MULTIPLE_CHOICE → "Tốc độ xử lý" + "Chất lượng sản phẩm"
('f0000002-0002-4000-8000-000000000005', 'e1000001-0002-4000-8000-000000000002', 'c1000001-0002-4000-8000-000000000002', NULL, '["d1020001-0002-4000-8000-000000000002","d1020001-0004-4000-8000-000000000004"]', NULL, NULL, NULL),

-- Response 3 (User 2, Survey 2)
-- Q1: SINGLE_CHOICE → "Đã học nhiều lần"
('f0000003-0001-4000-8000-000000000006', 'e2000001-0001-4000-8000-000000000003', 'c2000001-0001-4000-8000-000000000001', 'd2010001-0001-4000-8000-000000000001', NULL, NULL, NULL, NULL),
-- Q2: MULTIPLE_CHOICE → "Udemy" + "YouTube"
('f0000003-0002-4000-8000-000000000007', 'e2000001-0001-4000-8000-000000000003', 'c2000001-0002-4000-8000-000000000002', NULL, '["d2020001-0001-4000-8000-000000000001","d2020001-0003-4000-8000-000000000003"]', NULL, NULL, NULL),
-- Q3: SINGLE_CHOICE → "200.000đ – 500.000đ"
('f0000003-0003-4000-8000-000000000008', 'e2000001-0001-4000-8000-000000000003', 'c2000001-0003-4000-8000-000000000003', 'd2030001-0002-4000-8000-000000000002', NULL, NULL, NULL, NULL),
-- Q4: PARAGRAPH
('f0000003-0004-4000-8000-000000000009', 'e2000001-0001-4000-8000-000000000003', 'c2000001-0004-4000-8000-000000000004', NULL, NULL, 'Hay bị mất kết nối internet khi học', NULL, NULL),

-- Response 4 (User 5, Survey 3)
-- Q1: SINGLE_CHOICE → "Căng thẳng vừa"
('f0000004-0001-4000-8000-000000000010', 'e3000001-0001-4000-8000-000000000004', 'c3000001-0001-4000-8000-000000000001', 'd3010001-0003-4000-8000-000000000003', NULL, NULL, NULL, NULL),
-- Q2: MULTIPLE_CHOICE → "Áp lực công việc" + "Vấn đề tài chính"
('f0000004-0002-4000-8000-000000000011', 'e3000001-0001-4000-8000-000000000004', 'c3000001-0002-4000-8000-000000000002', NULL, '["d3020001-0001-4000-8000-000000000001","d3020001-0002-4000-8000-000000000002"]', NULL, NULL, NULL),

-- Response 5 (Anonymous, Survey 1)
-- Q1: SINGLE_CHOICE → "Bình thường"
('f0000005-0001-4000-8000-000000000012', 'e1000001-0003-4000-8000-000000000005', 'c1000001-0001-4000-8000-000000000001', 'd1010001-0003-4000-8000-000000000003', NULL, NULL, NULL, NULL),
-- Q2: MULTIPLE_CHOICE → "Hỗ trợ sau bán hàng"
('f0000005-0002-4000-8000-000000000013', 'e1000001-0003-4000-8000-000000000005', 'c1000001-0002-4000-8000-000000000002', NULL, '["d1020001-0005-4000-8000-000000000005"]', NULL, NULL, NULL),
-- Q3: TEXT
('f0000005-0003-4000-8000-000000000014', 'e1000001-0003-4000-8000-000000000005', 'c1000001-0003-4000-8000-000000000003', NULL, NULL, 'Cần cải thiện giao diện website', NULL, NULL);
